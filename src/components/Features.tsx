    ...
    return (
        <section className="py-8">
            <div className="max-w-screen-xl px-4 py-8 mx-auto text-center">
                <h2 className="text-5xl font-extrabold tracking-tight text-black">Our Features</h2>
                <p className="text-black mt-4 mb-12">Explore the benefits of using AuctionMania.</p>
