            ...
            <form onSubmit={handleSubmit} className="space-y-8 max-w-lg w-full bg-white p-8 rounded-lg shadow-md">
                ...
                <div className="grid grid-cols-1 gap-y-6">
                    ...
                    <div>
                        ...
                        <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-400 px-6 py-10 bg-gray-50">
                        ...
                        {imageBase64 && (
                            <div className="mt-4">
                                <img src={imageBase64} alt="Preview" className="mx-auto h-48 w-auto rounded-md shadow-md" />
                            </div>
                        )}
                    </div>
                </div>
